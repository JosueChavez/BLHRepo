...
public class OperacionesUsuarios {
    ...
    public void ActualizarUsuarios(String newUser, String pass, String viejoUs, String viejoPass) {
        try {
            int updateRows = 0;
            PreparedStatement sentencia = con.conectar().prepareStatement("UPDATE Usuario SET Username ='" + newUser + "', Password ='" + pass + "' WHERE Username = '" + viejoUs + "' AND Password = '" + viejoPass + "'");
