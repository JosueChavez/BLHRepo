...
//        this.setLocationRelativeTo(null);
    ...
    private void initComponents() {
        ...
        jcbSeleccionarBusquedaDonante.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Documento", "Nombres\t", "Apellidos" }));
        ...
        jbExcel.setToolTipText("Muestra los datos de todas las donante en Excel");
        ...
        jbExcell1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/page_excel.png"))); // NOI18N
        jbExcell1.setToolTipText("Muestra los datos de la donante en Excel");
        jbExcell1.setEnabled(false);
        jbExcell1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbExcell1ActionPerformed(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
...
private void jbExcell1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbExcell1ActionPerformed
    // TODO add your handling code here:
}//GEN-LAST:event_jbExcell1ActionPerformed
...
private void jcFechaNacDateChanged(org.freixas.jcalendar.DateEvent evt) {//GEN-FIRST:event_jcFechaNacDateChanged
    Date fechaN = jcFechaParto.getDate();
//        fecha = fechaNa.toString();
//        calcularEdad(fechaNa);
    java.util.Date date = new java.util.Date();
    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd");
    fechaNac = sdf.format(fechaN);
...
private void jcFechaObtDatosDateChanged(org.freixas.jcalendar.DateEvent evt) {//GEN-FIRST:event_jcFechaObtDatosDateChanged
    Date fechaOD = jcFechaParto.getDate();
//        fecha = fechaNa.toString();
//        calcularEdad(fechaNa);
    java.util.Date date = new java.util.Date();
    java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd");
    fechaObtDatos = sdf.format(fechaOD);
...
private void jbGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbGuardarActionPerformed
 // TODO add your handling code here:
    ...
    private javax.swing.JButton jbExcell1;
