...
private void jbAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAgregarActionPerformed
     if (jtVehiculos.getSelectedRow() == -1) {
            ...
            try {
//                recoleccionDomiciliar.vehiculo = (jtVehiculos.getValueAt(jtVehiculos.getSelectedRow(), 1).toString() + " - Placas: " + jtVehiculos.getValueAt(jtVehiculos.getSelectedRow(), 0).toString());
//                new RutaRecDomiciliar().setVisible(true);
//                this.setVisible(false);
                comoSalir();
            } catch (Exception e) {
