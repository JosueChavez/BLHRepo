...
public class RecoleccionDomiciliar extends javax.swing.JFrame {
    ...
    static public String indiceOculto = "";
    ...
    public RecoleccionDomiciliar() {
        ...
        jlIndiceOculto.setText(indiceOculto);
    }
    ...
    private void initComponents() {
        ...
        gridBagConstraints.gridwidth = 3;
        gridBagConstraints.gridheight = 2;
        jPanel1.add(jbImprimir, gridBagConstraints);
        ...
        setBounds((screenSize.width-1040)/2, (screenSize.height-604)/2, 1040, 604);
...
private void jbNuevaRutaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbNuevaRutaActionPerformed
    ...
    rrd.setVisible(true);
    indiceOculto = jlIndiceOculto.getText();
    RutaRecDomiciliar.jlIndiceOc.setText(indiceOculto);
...
private void jbEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbEliminarActionPerformed
    ...
    try {
        if (jtRutas.getSelectedRow() == -1) {
            ...
            int msj = JOptionPane.showConfirmDialog(rootPane, "¿En verdad desea eliminar las rutas\ncon número igual al: " + jtRutas.getValueAt(jtRutas.getSelectedRow(), 0) + "?", "Confirmación", JOptionPane.YES_NO_OPTION);
            if (msj == 0) {
    ...
    private void jbModificarRutaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbModificarRutaActionPerformed
        ...
        if (jtRutas.getSelectedRow() == -1) {
            ...
            RutaRecDomiciliar rrd = new RutaRecDomiciliar();
            rrd.setVisible(true);
            rrd.jSpinner1.setVisible(false);
    ...
    private void jbImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbImprimirActionPerformed
        // TODO add your handling code here:
        if (jtRutas.getSelectedRow() == -1) {
            JOptionPane.showMessageDialog(rootPane, "¡Seleccione la Fecha para Imprimir!");
        } else {
            opR.runReporteRuta("Rutas", jtRutas.getValueAt(jtRutas.getSelectedRow(), 1).toString());
        }
    ...
    public static javax.swing.JButton jbModificarRuta;
    public static javax.swing.JButton jbNuevaRuta;
