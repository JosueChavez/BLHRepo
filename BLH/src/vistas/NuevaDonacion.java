...
public class NuevaDonacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcFechaVenc = new org.freixas.jcalendar.JCalendarCombo();
        jtfFrasco = new javax.swing.JTextField();
        ...
        jLabel6.setText("Número de Frasco:");
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 1;
        ...
        jcFechaVenc.addDateListener(new org.freixas.jcalendar.DateListener() {
            public void dateChanged(org.freixas.jcalendar.DateEvent evt) {
                jcFechaVencDateChanged(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        ...
        jPanel5.add(jcFechaVenc, gridBagConstraints);

        jtfFrasco.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                jtfFrascoFocusLost(evt);
            }
        });
        gridBagConstraints = new java.awt.GridBagConstraints();
        gridBagConstraints.gridx = 14;
        ...
        gridBagConstraints.gridwidth = 7;
        gridBagConstraints.gridheight = 3;
        jPanel5.add(jtfFrasco, gridBagConstraints);
    ...
    public void fecha2() {
        Date fechaNa = jcFechaVenc.getDate();
        java.util.Date date = new java.util.Date();
        java.text.SimpleDateFormat sdf = new java.text.SimpleDateFormat("yyyy-MM-dd");
        fechaVen = sdf.format(fechaNa);
    }
    ...
    private void jbIdRutaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbIdRutaActionPerformed
        ...
        RecoleccionDomiciliar.jbEliminar.setVisible(false);
        RecoleccionDomiciliar.jbModificarRuta.setVisible(false);
        RecoleccionDomiciliar.jbNuevaRuta.setVisible(false);
        RecoleccionDomiciliar.jlIndiceOculto.setText("4");
...
private void jbAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbAceptarActionPerformed
    if (bgTipoDonacion.isSelected(null) || jtfFrasco.getText().equals("") || jtfRacionAceptada.getText().equals("") || jtfRacionDescartada.getText().equals("")) {
        JOptionPane.showMessageDialog(null, "¡Por favor, complete los datos de la donación!");
    } else {
        documento = jlDocumento.getText();
        Donacion don = new Donacion(fechaDon, tipoDon, racAceptada, racDescartada, documento, estatura, peso, frasco, fechaVen);
...
private void jrbLocalItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jrbLocalItemStateChanged
    ...
    private void jcFechaVencDateChanged(org.freixas.jcalendar.DateEvent evt) {//GEN-FIRST:event_jcFechaVencDateChanged
        // TODO add your handling code here:
        fecha2();
    }//GEN-LAST:event_jcFechaVencDateChanged
    
    private void jtfFrascoFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jtfFrascoFocusLost
        // TODO add your handling code here:
        frasco = jtfFrasco.getText();
    }//GEN-LAST:event_jtfFrascoFocusLost
    ...
    public static org.freixas.jcalendar.JCalendarCombo jcFechaVenc;
    ...
    private javax.swing.JTextField jtfFrasco;
